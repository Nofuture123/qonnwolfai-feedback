...
1. 点上方 **Issues** → **New issue** → 选「问题反馈」
2. 按表单填写:选产品、写清复现步骤
3. 提交后机器人会自动把反馈转入开发仓,并在你的 issue 下回复跟进链接

## 注意

- 描述越具体(复现步骤、截图、报错原文),修复越快
- 一个问题一条 issue,不要打包多个问题
- **本仓库是公开的**:截图里不要出现学生姓名、账号密码等敏感信息,必要时打码后再上传
